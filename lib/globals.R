...
osfa_dashboard      <- "https://outlookuga-my.sharepoint.com/:x:/r/personal/rtucker_uga_edu/Documents/OSFA%20Data.xlsx?d=w27172e55085f424a818e022f59d49d07&csf=1"
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
osfaDashboard <- "http://apps.osfa.uga.edu/decrypt.php?path=Banner/Argos/Dashboard_Data/OSFA%20FUNDS%20-%20TERM%20DATA_"
osfaDashboardExt <- ".csv"
# --------------------------------------------------------------------------
